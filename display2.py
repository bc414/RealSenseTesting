...
while True:
    ...
    verts2 = np.load("verts2.npy")
    #print("translation shape: ",translation.shape)
    #verts2 = np.transpose(verts2).dot(rotation)
    verts2 = rotation.dot(np.transpose(verts2))
    verts2final = verts2 + translation
    verts2 = np.transpose(verts2final)
    texcoords2 = np.load("texcoords2.npy")
    colorSource2 = np.load("colorSource2.npy")
